...
This is the _full_ feature set of the upstream app — used to scope an MVP.
...
- **Fill style** _(when bg ≠ transparent)_: Hachure / Cross-hatch / Solid (verified upstream)
...
- **Actions** _(visible only when actually selected)_: Duplicate, Delete, Group, Ungroup, Lock, Add link, Flip H, Flip V

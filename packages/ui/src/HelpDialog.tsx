...
const EDITOR_SHORTCUTS: readonly Shortcut[] = [
  ...
  { keys: "Drag top handle", label: "shortcuts:rotate" },
  { keys: "Shift + rotate", label: "shortcuts:rotateSnap" },
  { keys: "Delete", label: "shortcuts:delete" },
  { keys: "Cmd/Ctrl+A", label: "shortcuts:selectAll" },
  { keys: "Esc", label: "shortcuts:deselect" },
  { keys: "Cmd/Ctrl+Alt+C", label: "shortcuts:copyStyles" },
  { keys: "Cmd/Ctrl+Alt+V", label: "shortcuts:pasteStyles" },
...
const VIEW_SHORTCUTS: readonly Shortcut[] = [
  ...
  { keys: "Alt+/", label: "shortcuts:stats" },
